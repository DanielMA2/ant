...
Tutorial_test::Tutorial_test(const string& name, OptionsPtr opts) :
    Physics(name, opts)
{
...
void Tutorial_test::ProcessEvent(const TEvent& event, manager_t&)
{
...
AUTO_REGISTER_PHYSICS(Tutorial_test)
